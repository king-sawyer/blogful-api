function makeArticlesArray() {
  ...
  function makeMaliciousArticle(){
    return {
    id:1,
    title:'<img src="https://url.to.file.which/does-not.exist" onerror="alert(document.cookie); alert(you just got pretend hacked! oh noes!);">',
    content: '<img src="https://url.to.file.which/does-not.exist" onerror="alert(document.cookie); alert(you just got pretend hacked! oh noes!);">',
    style:'Story'
